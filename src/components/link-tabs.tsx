...
function LinkTabs({ children }: LinkTabsProps) {
    ...
    return (
        <nav>
            <ul className="flex border-b dark:border-dark-100/20 space-x-6">
    ...
    return (
        <li
            className={`cursor-pointer pb-1.5 ${
                isActive
                    ? "border-b-2 border-light-100 dark:border-dark-100 text-light-100 dark:text-dark-100"
                    : "text-light-400 dark:text-dark-400 hover:border-b-2 hover:dark:border-dark-100/40 hover:text-blue-500 hover:dark:text-blue-600"
            }`}
            onClick={onClick}
        >
