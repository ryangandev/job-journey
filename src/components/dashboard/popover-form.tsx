  ...
  return (
    ...
    >
      ...
      <PopoverContent className="w-[400px] px-4 py-2">
        {(titleProps) => (
          <div className="w-full space-y-2 px-1 py-2">
            <p
            ...
            <div className="flex">
              <span className="select-none text-tiny text-light-400 dark:text-dark-400">
                Press escape to{' '}
                <span className="text-light-100 dark:text-dark-100">
                  cancel
                </span>{' '}
                · enter to{' '}
                <span className="text-light-100 dark:text-dark-100">save</span>
              </span>
            </div>
          </div>
        )}
